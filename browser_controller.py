        ...
        try:
            ...
            if action_type == "click":
                ...
                if "start_box" in action_inputs and "end_box" in action_inputs:
                    ...
                    start_x = round(float(start_box[0]) / 1000 * self.viewport["width"], 3)
                    start_y = round(float(start_box[1]) / 1000 * self.viewport["height"], 3)
                    end_x = round(float(end_box[0]) / 1000 * self.viewport["width"], 3)
                    end_y = round(float(end_box[1]) / 1000 * self.viewport["height"], 3)
